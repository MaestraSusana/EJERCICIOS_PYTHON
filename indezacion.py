...
print(" ".join(lista_mascotas[::-1]))  # Cadena invertida con espacios
print("".join(lista_mascotas[::-1]))  # Cadena invertida sin espacios
...
print(respuesta2)
print(respuesta2[0:2:1]+" "+ (respuesta2[2:5:1])+ " "+ (respuesta2[5:11:1])+" "+(respuesta2[11:15:1])+" "+(respuesta2[15:17]))